"""The math the YouTube steps share: format filter, channel medians, hit weights."""
...
def channel_uploads(channel_id: str) -> list[Video]:
    ...
    uploads = [video for video in youtube_api.recent_uploads(channel_id) if matches_format(video)]
